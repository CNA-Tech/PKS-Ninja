...
If you are looking for instructions to deploy the standard planespotter app, please see the [Deploy Planespotter App](https://github.com/CNA-Tech/PKS-Ninja/blob/Pks1.4/LabGuides/BonusLabs/Deploy%20Planespotter%20Lab/readme.md) lab guide
