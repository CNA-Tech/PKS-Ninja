...
## Prereqs
### NOTE: The supported upgrade paths to Enterprise PKS v1.5.0 are from Enterprise PKS v1.4.1 and later.
For this lab, you will need access to a PKS Ninja lab environment with a working PKS 1.4.1 deployment and a PKS deployed kubernetes cluster.
